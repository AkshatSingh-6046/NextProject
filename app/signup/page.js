        ...
        <div>
          ...
          <div className="flex">
            <input
              ...
              {error?.password2?<div className="flex items-center text-sm text-red-700">{error?.password2}</div>:null}
        </div>
          
        </div>
        <div className="flex w-4/5 mr-8 justify-end mt-4 text-gray-700 text-[12px]">Already a user? &nbsp;<Link className="text-blue-800" href='/login'>Login</Link></div>
